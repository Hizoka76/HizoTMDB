...
try:
    ...
    try:
        ...
        try:
            ...
            print("Impossible to find PySide6 / PySide2 / PyQt5.<br>You need to install one of them !<br><br>PySide6: <b>pip3 install pyside6</b><br>PySide2: <b>sudo apt install python3-pyside2</b><br>PyQt5: <b>sudo apt install python3-pyqt5</b>")

            if which("kdialog"):
                popen("""kdialog --error "Impossible to find PySide6 / PySide2 / PyQt5.<br>You need to install one of them:<br><br>PySide6: <b>pip3 install pyside6</b><br>PySide2: <b>sudo apt install python3-pyside2</b><br>PyQt5: <b>sudo apt install python3-pyqt5</b>" """)

            elif which("zenity"):
                popen("""zenity --error --no-wrap --text "Impossible to find PySide6 / PySide2 / PyQt5.\nYou need to install one of them:\n\nPySide6: <b>pip3 install pyside6</b>\nPySide2: <b>sudo apt install python3-pyside2</b>\nPyQt5: <b>sudo apt install python3-pyqt5</b>" """)
...
class ThreadActions(QRunnable):
    ...
    def Movies(self):
        ...
        for Name in self.Names:
            ...
            # Nettoyage du nom
            NameFinded = Name.lower()
            NameFinded = NameFinded.replace("*", "")
...
if __name__ == '__main__':
    ...
    HizoTMDB.setApplicationVersion("1.0.0") # Version de l'application
